package com.github.dge1992.common.database;
...
public class DatabaseMetaUtil {
     ...
     * @throws Exception
     */
    public String getDDLByTableName(String tableName) throws Exception {
        String createDDL = "";
    ...
    public String getCommentByTableName(String tableName) throws Exception{
        String DDL = getDDLByTableName(tableName);
        return DDL.substring(DDL.indexOf("COMMENT='") + 9, DDL.length() - 1);
    }
...
//        metaData.getTableColumns("root", "user");
        // System.out.println("=======================");
        ...
        // }
        //metaData.getDDLByTableName("user");
        System.out.println(metaData.getCommentByTableName("user"));
    }
}
